...
def play_view(catalogue):
    ...
    try:
        ...
        for quality in qualities:
            response = requests.post('https://app.pluralsight.com/video/clips/viewclip', json={"author":clip.author_handle, "includeCaptions":False, "clipIndex":clip_id, "courseName":course_name, "locale":"en", "moduleName":module_name, "mediaType":"mp4", "quality":quality})
