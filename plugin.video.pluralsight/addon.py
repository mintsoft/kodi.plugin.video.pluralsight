...
def main():
    global base_url, addon_handle, args, database_path, username, password, catalog
    ...
    if mode is None:
        ...
        courses_view(catalog.get_courses_by_category_id(category_id))
